...
def check_diagonal_win_positive_slope(board: list[list[int]], last_move: tuple[int]) -> bool: 
...
def test_diagonal_win_positive_slope():
    assert check_diagonal_win_positive_slope(board_diagonal_win_positive_slope, (1,5)) == True

def test_diagonal_loss_positive_slope():
    assert check_diagonal_win_positive_slope(board_diagonal_loss_positive_slope, (4,2)) == False

def test_diagonal_loss_three_values():
    assert check_diagonal_win_positive_slope(board_diagonal_loss_positive_slope_three_in_row, (4,1)) == False