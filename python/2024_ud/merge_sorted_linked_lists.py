...
def test_one_second():
    assert merge_ll_again(
        build_linked_list([1, 2, 4]), build_linked_list([1, 3, 4])
    ) == ListNode(
        1, ListNode(1, ListNode(2, ListNode(3, ListNode(4, ListNode(4, None)))))
    )
...
def test_single_value_ll():
    assert merge_ll(build_linked_list([1]), build_linked_list([3])) == ListNode(
        1, ListNode(3, None)
    )
