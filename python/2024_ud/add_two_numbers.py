...
def test_one():
    ...
    """
    assert add_two_linked_lists(
        listnode_builder([2, 4, 3]), listnode_builder([5, 6, 4])
    ) == listnode_builder([7, 0, 8])
...
def test_nine_nine_one():
    ...
    """
    assert add_two_linked_lists(
        listnode_builder([9, 9, 1]), listnode_builder([1])
    ) == listnode_builder([0, 0, 2])
...
def test_list_of_nines():
    ...
    """
    assert add_two_linked_lists(
        listnode_builder([9]), listnode_builder([1, 9, 9, 9, 9, 9, 8, 9, 9, 9])
    ) == listnode_builder([0, 0, 0, 0, 0, 0, 9, 9, 9])
...
def test_long_things():
    ...
    """
    assert add_two_linked_lists(
        listnode_builder([0, 8, 6, 5, 6, 8, 3, 5, 7]),
        listnode_builder([6, 7, 8, 0, 8, 5, 8, 9, 7]),
    ) == listnode_builder([6, 5, 5, 6, 4, 4, 2, 5, 5, 1])
